...
public class LimboportalTileRenderer<T extends LimboPortalTile> extends TileEntityRenderer<T> {
	public static final ResourceLocation END_SKY_TEXTURE = new ResourceLocation("the_descending_dimensions:textures/blocks/bedrock.png");
	public static final ResourceLocation END_PORTAL_TEXTURE = new ResourceLocation("the_descending_dimensions:textures/blocks/bedrock.png");
	private static final Random RANDOM = new Random(31100L);
	private static final List<RenderType> RENDER_TYPES = IntStream.range(0, 16).mapToObj((p_228882_0_) -> {
		return TDDRenderType.getLimboPortal(p_228882_0_ + 1);
	}).collect(ImmutableList.toImmutableList());
	public LimboportalTileRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
		super(rendererDispatcherIn);
	}

	public void render(T tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn,
	...
	private void renderFace(T tileEntityIn, Matrix4f p_228884_2_, IVertexBuilder p_228884_3_, float p_228884_4_, float p_228884_5_, float p_228884_6_,
			float p_228884_7_, float p_228884_8_, float p_228884_9_, float p_228884_10_, float p_228884_11_, float p_228884_12_, float p_228884_13_,
			float p_228884_14_, Direction p_228884_15_) {

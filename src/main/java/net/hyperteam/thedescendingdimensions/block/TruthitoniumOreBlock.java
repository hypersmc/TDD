...
public class TruthitoniumOreBlock extends TheDescendingDimensionsModElements.ModElement {
	@ObjectHolder("the_descending_dimensions:truthitonium_ore")
	public static final Block block = null;
	public TruthitoniumOreBlock(TheDescendingDimensionsModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("truthitonium_ore");
		}

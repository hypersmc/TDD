...
public class TranstoriumOreBlock extends TheDescendingDimensionsModElements.ModElement {
	@ObjectHolder("the_descending_dimensions:transtorium_ore")
	public static final Block block = null;
	public TranstoriumOreBlock(TheDescendingDimensionsModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("transtorium_ore");
		}

...
public class TestBlock extends TheDescendingDimensionsModElements.ModElement {
	@ObjectHolder("the_descending_dimensions:test")
	public static final Block block = null;
	public TestBlock(TheDescendingDimensionsModElements instance) {
		super(instance, 25);
	}

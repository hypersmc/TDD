...
public class KilithiniteOreBlock extends TheDescendingDimensionsModElements.ModElement {
	@ObjectHolder("the_descending_dimensions:kilithinite_ore")
	public static final Block block = null;
	public KilithiniteOreBlock(TheDescendingDimensionsModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("kilithinite_ore");
		}

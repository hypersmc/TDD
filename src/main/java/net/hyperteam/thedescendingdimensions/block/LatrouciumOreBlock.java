...
public class LatrouciumOreBlock extends TheDescendingDimensionsModElements.ModElement {
	@ObjectHolder("the_descending_dimensions:latroucium_ore")
	public static final Block block = null;
	public LatrouciumOreBlock(TheDescendingDimensionsModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("latroucium_ore");
		}
